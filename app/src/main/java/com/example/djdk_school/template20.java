...
public class template20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText EditText_five = (EditText)findViewById(R.id.EditText_five);
        ...
        EditText_five.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                EditText_five.setTextSize(50);
                return false;
            }
        });
